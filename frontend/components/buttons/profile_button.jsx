...
var ProfileButton = React.createClass({
  ...
  render: function() {
    ...
    var profileClass = this.state.active
      ? "profile-actions tooltip"
      : "profile-actions tooltip hide";
    ...
    return (
      <div className="navbar-profile">
        ...
        <ul className={profileClass}>
          <li key={"prof-new-story"}>
            <a href="#/new-story">New Story</a>
          </li>
          <li key={"prof-drafts"}>
            <a href="#/me/stories">Drafts and stories</a>
          </li>
          <li key={"prof-link"}>
            <a href={authorLink}>Profile</a>
          </li>
          <li onClick={this.logoutAuthor} key={"prof-signout"}>
            <a>Sign Out</a>
          </li>
        </ul>
      </div>
